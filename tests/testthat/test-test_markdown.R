...
sample_markdown <- structure(
    ...
    spec = structure(list(cols = structure(
        list(char = structure(list(), class = c("collector_character","collector")),
             int = structure(list(), class = c("collector_integer", "collector")),
